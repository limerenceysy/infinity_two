...
cfg=4
tau=0.5 #温度参数，控制随机性，0.5表示中等随机性
rope2d_normalized_by_hw=2
add_lvl_embeding_only_first_block=1 #是否仅在第一个块中添加层级嵌入
rope2d_each_sa_layer=1
text_encoder_ckpt=weights/flan-t5-xl
text_channels=2048 #文本编码器的输出通道数
apply_spatial_patchify=0 #是否应用空间分块，0表示不应用

# run inference
export PYTHONPATH=/home/yangsiya/Infinity-main:$PYTHONPATH
